    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-12">
            ...
            <div class="animate-on-scroll group p-8 rounded-2xl opacity-0 transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 cursor-pointer relative overflow-hidden glass-card"
                ...
                <div class="absolute -inset-1 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500 -z-10"></div>
            ...
            <div class="animate-on-scroll group p-8 rounded-2xl opacity-0 transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 cursor-pointer relative overflow-hidden glass-card"
                ...
                {{-- Simple Glow Behind Card --}}
                <div class="absolute -inset-1 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500 -z-10"></div>
