<header class="fixed top-0 w-full z-50 glass-card shadow-lg">
    ...
    <nav class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20 py-2">
            <a href="/" class="flex items-center gap-3" style="margin-left: -100px;">
                ...
                <div>
                    <div class="font-bold text-base leading-tight" style="color: #000000;">BEM REMA UPI</div>
                    <div class="text-xs leading-tight mt-0.5" style="color: #000000;">KABINET SUAR SANGGA 2025</div>
                </div>
            </a>

            <div class="hidden md:flex items-center gap-8">
                <a href="/" class="relative text-gray-600 hover:text-primary transition-all duration-300 text-sm pb-1 font-medium group magnetic-effect {{ request()->is('/') ? 'text-primary font-semibold' : '' }}">
                    Beranda
                ...
                <a href="/tentang" class="relative text-gray-600 hover:text-primary transition-all duration-300 text-sm pb-1 font-medium group magnetic-effect {{ request()->is('tentang') ? 'text-primary font-semibold' : '' }}">
                    Tentang
                ...
                <a href="/berita" class="relative text-gray-600 hover:text-primary transition-all duration-300 text-sm pb-1 font-medium group magnetic-effect {{ request()->is('berita') ? 'text-primary font-semibold' : '' }}">
                    Berita
