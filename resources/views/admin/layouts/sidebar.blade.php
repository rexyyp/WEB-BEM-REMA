...
<aside class="sidebar" style="position: fixed; top: 0; left: 0; bottom: 0; width: 270px; background: linear-gradient(180deg, #0F1C30 0%, #1E3A5F 100%); overflow-y: auto; z-index: 1000;">
    ...
    <div style="padding: 32px 24px; border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
        <div style="display: flex; align-items: center; gap: 16px;">
            <div style="width: 64px; height: 64px; background: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                <img src="{{ asset('build/assets/image/Logo Suar Sangga.png') }}" alt="Logo" style="width: 48px; height: 48px; object-fit: contain;">
            </div>
            <div>
    ...
    <nav style="padding: 24px 0;">
        <a href="{{ route('admin.dashboard') }}" class="nav-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 12px; padding: 12px 16px; margin: 4px 12px; border-radius: 10px; color: {{ request()->routeIs('admin.dashboard') ? '#60a5fa' : '#94a3b8' }}; font-size: 14px; font-weight: 500; text-decoration: none; background: {{ request()->routeIs('admin.dashboard') ? 'rgba(96, 165, 250, 0.15)' : 'transparent' }};">
            <div class="nav-icon" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; background: {{ request()->routeIs('admin.dashboard') ? 'rgba(96, 165, 250, 0.2)' : 'rgba(255, 255, 255, 0.1)' }}; border-radius: 8px;">
    ...
    <div style="position: absolute; bottom: 0; left: 0; right: 0; padding: 24px; border-top: 1px solid rgba(255, 255, 255, 0.1);">
        <a href="{{ route('admin.login') }}" style="display: flex; align-items: center; justify-content: center; gap: 8px; padding: 12px; background: rgba(220, 38, 38, 0.1); border: 1px solid rgba(220, 38, 38, 0.3); border-radius: 10px; color: #f87171; font-size: 14px; font-weight: 600; text-decoration: none;">
            <svg style="width: 18px; height: 18px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
