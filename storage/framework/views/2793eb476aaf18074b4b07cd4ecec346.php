    ...
    <div class="max-w-7xl mx-auto relative z-10">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto items-stretch">
            ...
            <?php $__currentLoopData = $leaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="animate-on-scroll opacity-0 transition-all duration-1000 h-full" style="perspective: 1500px; transform: translateY(40px); transition-delay: <?php echo e($index * 200); ?>ms;">
                    <div class="card-3d-tilt-leadership bg-white rounded-3xl shadow-xl group relative overflow-hidden h-full" style="transform-style: preserve-3d; will-change: transform;" data-tilt>
                        ...
                        <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" style="background: linear-gradient(135deg, <?php echo e($index === 0 ? 'rgba(250, 204, 21, 0.05)' : 'rgba(55, 83, 122, 0.05)'); ?>, transparent);"></div>
                        
                        
                        <div class="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" style="background: linear-gradient(135deg, <?php echo e($index === 0 ? '#FACC15' : '#37537A'); ?>, transparent); padding: 2px;">
                            <div class="w-full h-full rounded-3xl bg-white"></div>
                        </div>
                        
                        <div class="relative grid grid-cols-5 gap-0" style="height: 100%;">
                            
                            <div class="col-span-2 <?php echo e($index === 1 ? 'order-2' : ''); ?> relative overflow-hidden">
                                <div class="absolute inset-0 opacity-10" style="background: linear-gradient(135deg, <?php echo e($index === 0 ? '#FACC15' : '#37537A'); ?>, transparent);"></div>
                                
                                <div class="relative h-full min-h-[400px]">
                                    <img
                                        src="<?php echo e($leader['image']); ?>"
                                    ...
                                    <div class="absolute inset-0 bg-gradient-to-<?php echo e($index === 0 ? 'r' : 'l'); ?> from-transparent via-transparent to-white/30"></div>
                                </div>
                            </div>
                            
                            
                            <div class="col-span-3 <?php echo e($index === 1 ? 'order-1' : ''); ?> p-6 flex flex-col relative" style="height: 100%;">
                                
                                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-3 self-start" style="background: linear-gradient(135deg, <?php echo e($index === 0 ? '#FACC15' : '#37537A'); ?>, <?php echo e($index === 0 ? '#F59E0B' : '#2563eb'); ?>);">
                                    <span class="w-2 h-2 bg-white rounded-full animate-pulse"></span>
                                    <span class="text-xs font-bold uppercase tracking-wider text-white"><?php echo e($index === 0 ? 'Presiden' : 'Wakil Presiden'); ?></span>
                                </div>
                                
                                <h3 class="text-xl md:text-2xl font-black mb-2 transition-all duration-300 group-hover:scale-105 transform origin-left" style="color: <?php echo e($index === 0 ? '#FACC15' : '#37537A'); ?>;">
                                    <?php echo e($leader['name']); ?>

                                </h3>
                                
                                <div class="w-14 h-1 rounded-full mb-3 transform group-hover:w-20 transition-all duration-500" style="background: linear-gradient(90deg, <?php echo e($index === 0 ? '#FACC15' : '#37537A'); ?>, transparent);"></div>
                                
                                
                                <div class="mb-2" style="opacity: 0.15;">
                                    <svg class="w-10 h-10" fill="<?php echo e($index === 0 ? '#FACC15' : '#37537A'); ?>" viewBox="0 0 24 24">
                                ...
                                <div class="absolute bottom-0 left-0 right-0 p-6">
                                    <a href="https://instagram.com/<?php echo e($index === 0 ? 'abualghifarii' : 'najrilfauzan'); ?>" target="_blank" 
                                       ...
                                       style="background: linear-gradient(135deg, <?php echo e($index === 0 ? '#FACC15' : '#37537A'); ?>, <?php echo e($index === 0 ? '#F59E0B' : '#2563eb'); ?>);">
                                ...
                                <div class="absolute top-4 <?php echo e($index === 0 ? 'right-4' : 'left-4'); ?> opacity-5 pointer-events-none" style="z-index: 0;">
                                    <svg class="w-16 h-16" fill="<?php echo e($index === 0 ? '#FACC15' : '#37537A'); ?>" viewBox="0 0 24 24">
                                        <path d="M6 17h3l2-4V7H5v6h3zm8 0h3l2-4V7h-6v6h3z"/>
                                    </svg>
                                </div>
                            </div>
...
<?php /**PATH C:\PROOJEC WEB REMA\WEB REMA\resources\views/partials/leadership.blade.php ENDPATH**/ ?>