        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12 pb-8 md:pb-12 border-b border-white/10">
            ...
            <div>
                <div class="flex items-center gap-3">
                    <img src="<?php echo e(asset('build/assets/image/Logo Suar Sangga.png')); ?>" alt="BEM REMA UPI Logo" class="h-12 w-auto">
                    <div>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <?php $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a
                            ...
                            target="<?php echo e($social['url'] !== '#' ? '_blank' : '_self'); ?>"
                            rel="<?php echo e($social['url'] !== '#' ? 'noopener noreferrer' : ''); ?>"
                        ...
                        >
                            <img src="<?php echo e(asset('build/assets/icon/' . $social['icon'])); ?>" alt="<?php echo e($social['label']); ?>" class="w-5 h-5 sm:w-6 sm:h-6 object-contain">
                        </a>
...
<?php /**PATH C:\PROOJEC WEB REMA\WEB REMA\resources\views/partials/footer.blade.php ENDPATH**/ ?>