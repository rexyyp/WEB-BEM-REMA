                    ...
                    <div style="display: grid; grid-template-columns: 1fr 420px; gap: 32px; margin-bottom: 32px;">
                        ...
                        <div>
                            ...
                            <div style="margin-bottom: 24px;">
                                ...
                                <input type="text" name="judul" placeholder="Masukkan judul berita..." value="<?php echo e(old('judul')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div style="margin-bottom: 24px;">
                                ...
                                <select name="kategori" style="width: 100%; padding: 12px 16px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px; font-family: inherit; transition: all 0.2s ease; box-sizing: border-box; background: white; cursor: pointer;">
                                    ...
                                    <option value="Rema PERS" <?php echo e(old('kategori') == 'Rema PERS' ? 'selected' : ''); ?>>Rema PERS</option>
                                    <option value="Program Kerja" <?php echo e(old('kategori') == 'Program Kerja' ? 'selected' : ''); ?>>Program Kerja</option>
                                </select>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div style="margin-bottom: 24px;">
                                ...
                                <input type="text" name="author" placeholder="Masukkan nama penulis" value="<?php echo e(old('author', 'Admin BEM REMA')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 32px;">
                        ...
                        <textarea id="articleContent" name="konten" rows="10" placeholder="Tulis konten artikel di sini...&#10;&#10;Tips:&#10;- Gunakan paragraf untuk setiap topik&#10;- Pisahkan dengan enter untuk readability" required style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; font-size: 14px; line-height: 1.6; font-family: inherit;"><?php echo e(old('konten')); ?></textarea>
...
<?php /**PATH C:\PROOJEC WEB REMA\WEB REMA\resources\views/admin/berita/create.blade.php ENDPATH**/ ?>