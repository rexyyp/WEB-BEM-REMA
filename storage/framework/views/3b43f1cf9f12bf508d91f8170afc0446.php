    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('berita.detail', $item->slug)); ?>" class="animate-on-scroll group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer hover:-translate-y-3 opacity-0 card-3d block" style="transform: translateY(30px); transition-delay: <?php echo e($index * 100); ?>ms; display: flex; flex-direction: column; min-height: 380px;">
                    ...
                    <div class="p-5 flex flex-col h-full justify-between">
                        <div class="flex items-center gap-4 text-xs text-gray-500 mb-3 flex-shrink-0">
                            <span class="flex items-center gap-2">
                                ...
                                <span><?php echo e(formatTanggalSingkat($item->tanggal)); ?></span>
                            </span>
                            <span class="flex items-center gap-2">
                                <svg class="w-3.5 h-3.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\PROOJEC WEB REMA\WEB REMA\resources\views/partials/news.blade.php ENDPATH**/ ?>