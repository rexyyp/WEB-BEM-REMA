...
<div class="relative w-full overflow-hidden flex items-center justify-center pt-20 md:pt-32 pb-12 md:pb-20 px-4"
     style="min-height: 100vh; background-image: url('<?php echo e(asset('build/assets/image/hero-bem.jpeg')); ?>'); background-size: cover; background-position: center; background-attachment: scroll;">
...
<?php /**PATH C:\PROOJEC WEB REMA\WEB REMA\resources\views/partials/hero.blade.php ENDPATH**/ ?>